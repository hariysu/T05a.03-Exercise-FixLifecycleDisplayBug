...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0 ; i<=mLifecycleCallbacks.size()-1 ; i++){
            //Log.d("deneme",mLifecycleCallbacks.get(i));
    ...
    protected void onDestroy() {
        ...
        System.out.println("aaaaa"+mLifecycleCallbacks.get(0)+mLifecycleCallbacks.get(1));
